...
The party finds themselves on floating islands connected by psionic chains and tree roots in what **Bru** identifies as the **Astral Sea**. The landscape consists of:
...
**Bru** discovers a massive tree that speaks telepathically, revealing itself as **Matthew Broadtwig**:
...
- Gives **Bru** a **seed** to plant in their world, claiming it will stabilize their reality
...
**Workshop Contents**:
- **Time gun schematics** (stolen by **Helisanna**) showing how to use explosions to tear through space-time
...
- **Red's** exceptional perception (Natural 20) reveals these crystals are artificially created rather than naturally occurring
...
The party meets **Marcus**, a arrogant chronomancer wearing a beret and working on timeline calculations. When he dismisses them as "simple minds," **Helisanna** challenges him to a musical duel:

**Performance Results**:
- **Helisanna** rolls 30 on performance, completely overwhelming **Marcus**
...
Despite repeated warnings not to enter the back room, **Bru** inevitably infiltrates what turns out to be a bathroom containing:
- A **pedestal** with dramatic lighting
- An **iron flask** of mysterious but obviously significant importance
- **Bru** successfully performs an Indiana Jones-style swap and steals the flask
...
- **Multidimensional Radio** (stolen by **Red**): Receives communications across realities
- **Time Gun Schematics** (stolen by **Helisanna**): Complete plans for time travel technology
- **Iron Flask** (stolen by **Bru**): Mysterious container of unknown but significant contents
...
- Near the cave system where **Red's** trials originally began
...
**Bru** continues his pattern of doing exactly what he's told not to do, successfully stealing the mysterious iron flask despite repeated warnings. His natural curiosity and disregard for authority consistently drives plot advancement.
...
**Red's** exceptional understanding of crystal technology provides crucial intelligence about the relationship between their world's violessence and the advanced power sources they've discovered.
...
3. **Iron Flask Mystery**: **Bru's** stolen artifact likely contains something of cosmic significance
...
- Advanced power sources for **Bru's** inventions
